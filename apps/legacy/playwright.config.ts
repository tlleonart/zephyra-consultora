...
export default defineConfig({
  ...
  // When PLAYWRIGHT_BASE_URL points at an already-running server, skip the
  // managed dev server (avoids the port-3000 collision when a dev server from
  // another session is already bound there).
