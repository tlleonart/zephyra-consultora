...
export const DashboardHome = ({ userId }: DashboardHomeProps) => {
  const stats = useQuery(api.stats.getDashboardStats, { userId });
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.subtitle}>
        Resumen del contenido de Zephyra Consultora
      </p>
      ...
      <div className={styles.grid}>
        <StatsCard
          ...
          subtitle={`${stats.blog.published} publicados, ${stats.blog.drafts} borradores`}
          href="/admin/blog"
          color="primary"
          icon={
        ...
        <StatsCard
          ...
          subtitle={`${stats.newsletter.total} total, ${stats.newsletter.active} activos`}
