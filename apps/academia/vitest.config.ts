...
// We keep node here because the suites in this app are pure logic (server
// actions with mocked Convex clients, session/JWT, middleware via NextRequest)
// and none of them touches the DOM.
